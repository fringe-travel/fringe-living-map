...
export const VIBERS: Record<string, ViberProfile> = {
  ...
  "jess.v": { handle: "jess.v", name: "Jess", region: "Boracay", story: "Hopping Station 2 bars, calling the crowd before it gets packed.", gradient: ["#ff5da2", "#ff9ec4"] },
  ...
  dax: { handle: "dax", name: "Dax", region: "Hood River", story: "Sends massive air. When Dax says it's going, it's going.", gradient: ["#f59e0b", "#ef4444"] },
};
