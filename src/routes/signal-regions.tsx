...
export const Route = createFileRoute("/signal-regions")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse every live region. Unlock real-time access to places around the world." },
      { property: "og:title", content: "Live Regions — FRiNGE" },
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      ...
      <h1 className="mt-3 max-w-3xl text-balance text-5xl font-extrabold tracking-tighter md:text-6xl">
        Every live region, on one map.
      </h1>
      <p className="mt-5 max-w-2xl text-lg text-foreground/60">
        Choose a region and unlock fresh vibes, active spots, and the live signal from people already there.
      </p>
